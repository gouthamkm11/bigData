...
public class turnstileData {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (args.length != 2) {
      System.out.printf(
          "Usage: turnstileDetails <input dir> <output dir>\n");
      System.exit(-1);
    }
     ...
     */
    job.setJarByClass(turnstileData.class);
    
    /*
     * Specify an easily-decipherable name for the job.
     * This job name will appear in reports and logs.
     */
    job.setJobName("turnstileData");
     ...
     */
    job.setMapperClass(turnstileMapper.class);
    job.setReducerClass(turnstileReducer.class);
